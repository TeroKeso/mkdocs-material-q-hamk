...
???+ Info
    Check the <a href='[System requirements](https://www.microsoft.com/en-us/windows/windows-11-specifications?r=1)' target='_blank'>System requirements</a> for Windows 11.
...
```
???+ info
    * Save your licence in a safe place 😊
